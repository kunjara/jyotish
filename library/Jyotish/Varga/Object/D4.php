...
class D4 extends \Jyotish\Varga\Varga {
	...
	public function getVargaRashi(array $ganitaRashi) {
		...
		if($ganitaRashi['degree'] < 7.5) {
			...
			$vargaRashi['rashi'] = Rashi::inZodiacRashi($ganitaRashi['rashi'], 4);
		} elseif($ganitaRashi['degree'] >= 15 and $ganitaRashi['degree'] < 22.5) {
			$vargaRashi['rashi'] = Rashi::inZodiacRashi($ganitaRashi['rashi'], 7);
		} else {
			$vargaRashi['rashi'] = Rashi::inZodiacRashi($ganitaRashi['rashi'], 10);
		}
